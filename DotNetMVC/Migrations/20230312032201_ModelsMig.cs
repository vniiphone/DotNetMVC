        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddCity = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AddDistrict = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AddWard = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AddHouse = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CateName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    CateDescription = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImgThumb = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupPhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SupName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SupEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AddId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Suppliers_Address_AddID",
                        column: x => x.AddId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CartTotle = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OderDetails", x => x.OderDetailsId);
                    table.ForeignKey(
                        name: "FK_OderDetails_Products_ProID",
                        column: x => x.ProId,
                        principalTable: "Products",
                        principalColumn: "ProId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    OderStatus = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Oders_OderDetails_OderDetailId",
                        column: x => x.OderDetailId,
                        principalTable: "OderDetails",
                        principalColumn: "OderDetailsId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OderDetails_ProId",
                table: "OderDetails",
                column: "ProId");

            migrationBuilder.CreateIndex(
                name: "IX_Oders_OderDetailId",
                table: "Oders",
                column: "OderDetailId");
